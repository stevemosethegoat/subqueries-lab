...
# CodeGrade step2
# Replace None with your code
df_zero_emp=pd.read_sql("SELECT o.officecode,o.city FROM offices o LEFT JOIN  employees e ON o.officecode=e.officecode WHERE e.employeeNumber IS NULL",conn)
df_zero_emp
...
# CodeGrade step3
# Replace df_employeece None with your code CodeGrade step3
